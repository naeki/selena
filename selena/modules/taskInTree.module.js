...
// Test module
testModule = {
    name : "checkTaskInTree",
    call : function(){
        
        selena.addFunction(this, "contextMenu_check", function(title) {
            return this
                .waitForVisible("[title='" + title + "']", TIMEOUT)
                    .then(
        ...
        selena.addFunction(this, "contextMenu_click", function(title) {
            return this
                .click("[title='" + title + "']")
                    .then(
...
testModule.tests.taskFocusUnFocus = {
    ...
    return this
        .contextMenu_check("Focus")
        .contextMenu_click("Focus")
        .contextMenu_check("Unfocus")
        .keys(["Escape"])
...
testModule.tests.taskUnfollowFollow = {
    call : function(taskName) {
        return this
            ...
            .contextMenu_check("Unfollow")
            .contextMenu_click("Unfollow")
            .contextMenu_check("Follow")
            .keys(["Escape"])

            .switchTabAndCallback(tabMap.second)
            .taskDDOpen(taskName)
            .contextMenu_check("Follow")
            .contextMenu_click("Follow")
            .contextMenu_check("Unfollow")
            .keys(["Escape"])
...
testModule.tests.taskColorChange = {
  ...
  return this
    ...
    .switchTabAndCallback(tabMap.second)
      .waitForExist("//*[@role='task' and contains(@style,'245, 113, 83')]//*[contains(text(),'" + taskName + "')]", TIMEOUT)
        .then(
